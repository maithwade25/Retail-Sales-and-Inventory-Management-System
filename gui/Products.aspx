<%@ Page Language="C#" AutoEventWireup="true"
    CodeBehind="Products.aspx.cs" Inherits="P4CApp.Products" %>
<!DOCTYPE html>
<html>
<head runat="server">
  <meta charset="utf-8" />
  ...
  <asp:Button ID="btnHome" runat="server" Text="HOME"
      ...
      <asp:GridView ID="gvProducts" runat="server" AutoGenerateColumns="False"
        ...
        <Columns>
          ...
          <asp:TemplateField HeaderText="Category">
            ...
            <EditItemTemplate>
              <asp:TextBox ID="txtEditCategory" runat="server"
                           Text='<%# Bind("Category") %>' CssClass="form-control" />
            </EditItemTemplate>
          </asp:TemplateField>
          ...
          <asp:TemplateField HeaderText="Stock Level">
            ...
            <EditItemTemplate>
              <asp:TextBox ID="txtEditStockLevel" runat="server"
                           Text='<%# Bind("StockLevel") %>' CssClass="form-control" />
            </EditItemTemplate>
          </asp:TemplateField>
          ...
          <asp:TemplateField HeaderText="Supplier ID">
            ...
            <EditItemTemplate>
              <asp:TextBox ID="txtEditSupplierID" runat="server"
    ...
    <div class="card p-3">
      <div class="mb-3">
        ...
        <asp:TextBox ID="txtProductID" runat="server" ReadOnly="True" CssClass="form-control" />
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        <asp:Label ID="lblSupplierID2" runat="server" Text="Supplier ID:" CssClass="form-label" />
